...
const AboutUs = () => {
  return (
    <>
      <Helmet>
        <title>About Praveen PyroPark</title>
        <meta
          name="description"
          content="Learn about Praveen PyroPark, your trusted cracker supplier from Sivakasi. Delivering safe and affordable fireworks across India."
        />
        <meta
          name="keywords"
          content="about Praveen PyroPark, sivakasi cracker company, trusted fireworks dealer, crackers city, fireworks brand"
        />

        <meta
          property="og:title"
          content="About Us - Praveen PyroPark"
        />
        <meta
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <h2 className="text-4xl font-bold mb-6 text-gray-800">
              About The Praveen PyroPark
            </h2>

            <div className="space-y-5 text-gray-600 text-lg leading-relaxed">
              <p>
                Praveen PyroPark the most trusted and reliable website
